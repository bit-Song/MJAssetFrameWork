...
namespace MJ.AssetFrameWork.ABFrame
{
    public class BundleTools : MonoBehaviour
    {
        ...
        public static void GenerateBundleModuleEnum()
        {
            ...
            if (File.Exists(GeneratorConfig.Instance.BundleModuleEnumFilePath))
            {
                File.Delete(GeneratorConfig.Instance.BundleModuleEnumFilePath);
                AssetDatabase.Refresh();
            }

            var writer = File.CreateText(GeneratorConfig.Instance.BundleModuleEnumFilePath);
            writer.WriteLine("/* ----------------------------------------------");
